          ...
          >
            <View style={[styles.marginBottom_10]}>
              ...
              >
                ...
                مثال هذا النص هو مثال يمكن ان يستبدل في نفس المساحه هذا النص هو
                مثال لنص يمكن ان يستبدل في نفس المساحه هذا النص هو مثال هذا النص
                هو مثال يمكن ان يستبدل في نفس المساحه هذا النص هو مثال لنص يمكن
                ان يستبدل في نفس المساحه هذا النص هو مثال هذا النص هو مثال يمكن
                ان يستبدل في نفس المساحه
              </Text>
            </View>
          </View>
        </View>
